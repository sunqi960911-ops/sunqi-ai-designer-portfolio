...
* LICENSE file in the root directory of this source tree.
*/
var require_scheduler_development$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	(function() {
		"use strict";
...
var require_scheduler$1 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
var require_react_reconciler_development = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = function $$$reconciler($$$hostConfig) {
		...
		var Scheduler = require_scheduler$1();
...
function diffProps(instance, { children: cN, key: kN, ref: rN, ...props }, { children: cP, key: kP, ref: rP, ...previous } = {}, remove = false) {
	...
	if (remove) {
		...
		for (let i = 0; i < previousKeys.length; i++) if (!props.hasOwnProperty(previousKeys[i])) entries.unshift([previousKeys[i], "__defaultremove"]);
	}
