import { BufferAttribute, BufferGeometry, Color, LineSegments, Matrix4, Ray, ShaderMaterial, Sphere, UniformsLib, Vector2, Vector3 } from "./three.js";
...
var fragmentShader = `
  ...
  void main() {
    ...
    #include <${/* @__PURE__ */ (() => parseInt("170".replace(/\D+/g, "")))() >= 154 ? "colorspace_fragment" : "encodings_fragment"}>
  }
`;
...
function raycast(raycaster, intersects) {
	...
	if (index !== null) {
		...
		for (let i = 0, l = indices.length - 1; i < l; i += step) {
			...
			if (ray.distanceSqToSegment(vStart, vEnd, interRay, interSegment) > precisionSq) continue;
